...
export const WithWithout = () => {
  return (
    <section className="bg-base-100 border-b border-gray-200">
      <div className="max-w-5xl mx-auto px-8 py-16 md:py-32 ">
        <h2 className="text-center font-extrabold text-3xl md:text-5xl tracking-tight mb-12 md:mb-20">
          Tired of juggling multiple marketing tools and losing leads in the
          process?
        </h2>

        <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-8 md:gap-12">
          <div className="bg-red-200/70 text-red-500 p-8 md:p-12 rounded-lg w-full ">
            <h3 className="font-bold text-lg mb-4">
              How Users Are Hurting Not Using Panorama
            </h3>
          ...
          <div className="bg-success/20 text-success p-8 md:p-12 rounded-lg w-full">
            <h3 className="font-bold text-lg mb-4">How Panorama</h3>

            <ul className="list-disc list-inside space-y-1.5 ">
              {/* Features of your product fixing the pain (try to match each with/withot lines) */}
              {[
                "Unified Platform: All-In-One CRM",
                "Automation",
